...
class Address implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('extrafield', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['extrafield'];
    }

    /**
     * Sets extrafield
     *
     * @param string|null $extrafield extrafield
     *
     * @return self
     */
    public function setExtrafield($extrafield)
    {
        if (is_null($extrafield)) {
            throw new \InvalidArgumentException('non-nullable extrafield cannot be null');
        }
        $this->container['extrafield'] = $extrafield;
