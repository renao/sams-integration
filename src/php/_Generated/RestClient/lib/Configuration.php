...
namespace SAMSPlugin\RestClient;
...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://wvv.sams-server.de/api/v2';
    ...
    {
        $report  = 'PHP SDK (SAMSPlugin\RestClient) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 2.1' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://wvv.sams-server.de/api/v2",
